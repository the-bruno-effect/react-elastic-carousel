...
var Track = function Track(_ref) {
  ...
  var originalChildren = React.useMemo(function () {
    return React__default.Children.map(React__default.Children.toArray(children), function (child, idx) {
  ...
  }, [children, width, paddingStyle, minVisibleItem, maxVisibleItem, prevItem, nextItem, autoTabIndexVisibleItems, cssPrefix]);
  ...
  var toRender = enableSwipe ? /*#__PURE__*/React__default.createElement("div", _extends({}, handlers, {
  ...
  _createClass(Carousel, [{
    ...
    value: function render() {
      ...
      var _this$getDerivedProps23 = this.getDerivedPropsFromBreakPoint(),
        ...
        preventScrollOnSwipe = _this$getDerivedProps23.preventScrollOnSwipe,
