...
var Track = function Track(_ref) {
  ...
  var originalChildren = useMemo(function () {
    return React.Children.map(React.Children.toArray(children), function (child, idx) {
  ...
  var toRender = enableSwipe ? /*#__PURE__*/React.createElement("div", _extends({}, handlers, {
